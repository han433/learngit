...
public class TeamResourceIntTest {
    ...
    private static final String DEFAULT_TEAM_TITLE = "AAAAAAAAAA";
    private static final String UPDATED_TEAM_TITLE = "BBBBBBBBBB";
    ...
    public void createTeam() throws Exception {
        ...
        assertThat(testTeam.getTeam_title()).isEqualTo(DEFAULT_TEAM_TITLE);
        assertThat(testTeam.getUser_id()).isEqualTo(DEFAULT_USER_ID);
    }
    ...
    public void getAllTeams() throws Exception {
        ...
        restTeamMockMvc.perform(get("/api/teams?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].team_title").value(hasItem(DEFAULT_TEAM_TITLE.toString())))
    ...
    public void getTeam() throws Exception {
        ...
        restTeamMockMvc.perform(get("/api/teams/{id}", team.getId()))
            ...
            .andExpect(jsonPath("$.team_title").value(DEFAULT_TEAM_TITLE.toString()))
    ...
    public void updateTeam() throws Exception {
        ...
        Team testTeam = teamList.get(teamList.size() - 1);
        assertThat(testTeam.getTeam_title()).isEqualTo(UPDATED_TEAM_TITLE);
        assertThat(testTeam.getUser_id()).isEqualTo(UPDATED_USER_ID);
    }
